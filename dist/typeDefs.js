...
const typeDefs = apollo_server_1.gql `
  ...
  type Query {
    ...
    articles(pageNo: Int, pageSize: Int, filterText: String, sortType: String, sortkey: String, zone: String): ArticleResult
    ...
    advancedSearchArticle(pageNo: Int, pageSize: Int,title: String, description: String, source: String, author: String,
        articleStatus: String, selectedZone: String, articleFromDate: String, articleToDate: String): ArticleResult
